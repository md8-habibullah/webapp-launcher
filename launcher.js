    ...
    class HabibullahLauncher extends HTMLElement {
        ...
        <style>
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .flip-card {
            background-color: transparent; width: 100%; height: 72px; perspective: 1000px;
          }

          .flip-card-inner {
            position: relative; width: 100%; height: 100%;
            /* Fast return speed when mouse leaves */
          ...
          .flip-card:hover .flip-card-inner, .flip-card:focus-within .flip-card-inner {
            ...
            /* Delayed flip when mouse enters */
          ...
          /* --- FRONT DESIGN (Google/Proton Style) --- */
          .flip-card-front {
          ...
          /* --- BACK DESIGN (Utility Actions) --- */
          .flip-card-back {
            background: linear-gradient(135deg, rgba(16, 185, 129, 0.15) 0%, rgba(16, 185, 129, 0.05) 100%);
            border: 1px solid rgba(16, 185, 129, 0.3); transform: rotateX(180deg);
            align-items: center; text-align: center; padding: 8px 12px;
          }
          ...
          .action-buttons { display: flex; gap: 8px; width: 100%; justify-content: center; }

          .copy-btn {
            background: rgba(0,0,0,0.4); border: 1px solid rgba(255,255,255,0.2); color: #fff; cursor: pointer;
            height: 30px; padding: 0 16px; border-radius: 6px; display: flex; align-items: center; gap: 6px;
            font-size: 12px; font-weight: 700; transition: all 0.2s; width: 100%; justify-content: center;
          }
        ...
        <div class="flip-card" tabindex="0">
          <div class="flip-card-inner">
            ...
            <div class="flip-card-front">
              <a href="${app.url}" target="_blank" class="front-link link-item">
